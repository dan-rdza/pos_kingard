...
class Database:
    ...
    def get_default_db_path(self):
        ...
        if os.name == 'nt':  # Windows
            ...
            app_data = Path.home() / '.sistema_jardin'
    ...
    def insert_initial_data(self, conn):
        ...
        try:
            ...
            conn.execute('''
                ...
                VALUES (1, 'Jardín de Niños', 'XAXX010101000', 'Dirección del plantel', 
                        '555-123-4567', '¡Gracias por su preferencia!')
            ''')
    ...
    def authenticate_user(self, username, password):
        ...
        with self.get_connection() as conn:
            cursor = conn.cursor()
            cursor.execute('''
                SELECT id, employee_code, first_name, second_name, role 
                FROM sellers 
